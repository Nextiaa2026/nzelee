...
export type AuthGoogleButtonProps = React.ComponentProps<"button">;

/**
 * OAuth row styled like the landing hero: pill shape, soft green border, clear
 * brand glyph (same pattern as components/external/SocialButtons.tsx).
 */
